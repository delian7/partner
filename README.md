...
+ Possible security problem - students can use the link ~/users/25/export or ~/users/25/clearall to export the csv or clear all partnerships. The link is not anywhere on the student's site view, they would have to know it and type it in manually.
